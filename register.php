...
<body>
	<?php  
		//as on clicking register button, in case there is error the page refreshes and cant see errors then.
		...
		<div class="login_box">
			...
			<div id="first">
				<form action="register.php" method="POST">
					...
					<input type="submit" class="btn btn-sm btn-success" name="login_button" value="Login">
					<br>
			...
			<div id="second">
				<form action="register.php" method="POST">
					...
					<input type="submit" class="btn btn-sm btn-success" name="register_button" value="Register">
					<br>
